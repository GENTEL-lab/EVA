...
| Executable training/evaluation components, or explicit omissions | [Training](../training/pretrain/README.md), [fine-tuning](../finetune/aptamer/script/README.md), [smoke workflow](REPRODUCTION.md#training-and-fine-tuning) | Small training and save/reload verified. Full pretraining, missing dense-model code and unresolved paper configurations are not claimed. |
...
| Precise checkpoint and dataset identities | `reproduction/milena_14b/manifest.json`, [resources](RESOURCES.md), [comparison resources](OFFICIAL_MODEL_RESOURCES.md) | Representative versions/hashes fixed. Other missing versions remain explicit; formal release and code DOI pending. |
...
| One end-to-end benchmark | [Download → inference → metrics → plots](REPRODUCTION.md#gpu-run-the-complete-milena-benchmark), [expected output](../reproduction/milena_14b/expected/README.md) | Completed for 135 Milena samples. The measured 0.00338 difference is documented and accepted for this example; the reference is preserved. |
