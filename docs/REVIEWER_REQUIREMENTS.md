...
| Executable training/evaluation components, or explicit omissions | [Training](../training/pretrain/README.md), [fine-tuning](../training/finetune/aptamer/script/README.md), [smoke workflow](REPRODUCTION.md#training-and-fine-tuning) | Small training and save/reload verified. The recovered [dense-control source](DENSE_CONTROL.md) is included. Full pretraining reruns and unresolved paper configurations are not claimed. |
