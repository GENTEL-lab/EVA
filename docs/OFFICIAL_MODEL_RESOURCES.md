...
|---|---|---|
| RNA-FM, RNABERT, RNA-MSM | [RNA-FM upstream](https://github.com/ml4bio/RNA-FM); [recorded model identities](../examples/reproduction/release/recovered_rna_snapshots_20260909.json) | Model/config/tokenizer snapshot and a compatible Transformers/Multimolecule environment; choose the appropriate masking, length and sequence/MSA protocol. |
...
| CodonGPT | [Preserved scoring worker](../examples/reproduction/benchmark/upstream/rna/external_scripts/compute_codongpt_ll.py) | Compatible checkpoint/tokenizer, Transformers version and codon preprocessing. |
...
The [RNA snapshot record](../examples/reproduction/release/recovered_rna_snapshots_20260909.json)
...
`examples/reproduction/release/model_manifests/`. Keep each manifest outside its model
...
The [additional asset record](../examples/reproduction/release/recovered_competitor_assets_20260909.json)
