...
class DecoderLayer(nn.Module):
    def __init__(self, config: RNAGenConfig, layer_idx: int, **moe_kwargs):
        super().__init__()
...
class RNAGenPreTrainedModel(PreTrainedModel):
    config_class = RNAGenConfig
    ...
    def _set_update_state_dict(self, update_fn: Callable | None = None):
        ...
        for child in self._modules.values():
            ...
            if isinstance(child, RNAGenPreTrainedModel):
...
class RNAGenModel(RNAGenPreTrainedModel):
...
class RNAGenForCausalLM(RNAGenPreTrainedModel, GenerationMixin):
