...
DEFAULT_EVA_ROOT = "/eva" if Path("/eva").exists() else "/data/yanjie_huang/eva/EVA1"
DEFAULT_SAE = (
    "/data/yanjie_huang/rna_benchmark/interpretability/"
    "DSSR_sequences/sae_evo2_online_1400M/sae_final.pt"
)
